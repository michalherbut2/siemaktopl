/*
  ...
  - You are about to drop the column `timeoutAddTemplate` on the `guild_configs` table. All the data in the column will be lost.
  - You are about to drop the column `timeoutRemoveTemplate` on the `guild_configs` table. All the data in the column will be lost.
...
CREATE TABLE "new_guild_configs" (
    ...
    "timeoutLogAddTemplate" TEXT DEFAULT '{target} w końcu **dostał przerwę** od {executor} na {timestamp} za **{reason}**.',
    "timeoutLogRemoveTemplate" TEXT DEFAULT 'niestety {executorId}, jak zbój, zasłużonej **pozbawił przerwy** Czcigodnego {targetId}.',
