/*
  ...
  - You are about to drop the column `durationSeconds` on the `punishment_logs` table. All the data in the column will be lost.
...
INSERT INTO "new_punishment_logs" ("createdAt", "expiresAt", "guildId", "id", "metadata", "moderatorUserId", "reason", "removalReason", "removedAt", "removedByUserId", "targetUserId", "type") SELECT "createdAt", "expiresAt", "guildId", "id", "metadata", "moderatorUserId", "reason", "removalReason", "removedAt", "removedByUserId", "targetUserId", "type" FROM "punishment_logs";
